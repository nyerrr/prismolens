...
const services = [
  {
    icon: '💍',
    title: 'Wedding Booth',
    description: 'Elegant setups with custom backdrops, floral props, and instant prints. We make sure every guest leaves with a memory from your special day.',
  ...
  },
  {
    ...
    description: 'Branded booths with company logo overlays, professional setup, and large print options. Ideal for product launches and team events.',
